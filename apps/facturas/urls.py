...
urlpatterns = [
    ...
    url(r'^articulos/(?P<product>[0-9]+)/eliminar/$',
    ...
    url(r'^buscar_articulo/(?P<code>[\w\-]+)/$', views.buscar_articulo, name="buscar_articulo"),
    url(r'^buscar_servicio/(?P<code>[\w\-]+)/$', views.buscar_servicio, name="buscar_servicio"),
]